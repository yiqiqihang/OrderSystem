...
<div id="div1">
    ...
    <form action="LoginService" id="form2">
        <table>
            ...
            <%--                <td><input type="submit" onclick="javascript:window.location.href='main.jsp'"  value="登&nbsp;&nbsp;录" class="sub">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
<%--                    <input type="submit"   onclick="javascript:window.location.href='register.jsp'" value="注&nbsp;&nbsp;册" class="sub"></td>--%>
            </tr>
        </table>
